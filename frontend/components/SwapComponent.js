...
import { useAccount, useProvider, useSigner, useBalance, useChainId } from 'wagmi'

// create metamask-react components
...
const SwapComponent = () => {
    ...
    // console.log("status: ", status, "account: ", account, "chainId: ", chainId, "ethereum: ", ethereum)
    ...
    return (
        <div className='flex justify-center mt-[100px]'>
            <div className='bg-[#affc41] w-[35%]  p-4 px-6 rounded-xl'>
                <div className='flex items-center justify-between py-4 px-1'>
                    <p>Swap</p>
                    <CogIcon className='h-6' />
                </div>
                <div className='relative bg-[#f7faff] p-4 py-6 rounded-xl mb-2 border-[2px] border-transparent hover:border-zinc-600'>
                    {srcTokenComp}
                ...
                <div className='bg-[#f7faff] p-4 py-6 rounded-xl mt-2 border-[2px] border-transparent hover:border-zinc-600'>
                    {destTokenComp}
                </div>

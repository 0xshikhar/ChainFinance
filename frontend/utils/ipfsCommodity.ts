...
// import { priceFeedToSymbol } from './marketData';
...
const createSvg = (market: Market, activeChain: string, priceFeed: string, commodity: string): string[] => {
    let asset = commodity + "_" + priceFeed;
...
const generateMetadata = (market: Market, overSVGURI: string, underSVGURI: string, activeChain: string, priceFeed: string, commodity: string) => {
